...
Construir testes para as classes do sistema e garantir uma cobertura de teste de 50%. Usando a cobertura do IntelliJ como base.
...
- Construir testes end to end utilizando Cucumber. Entregando, assim, um projeto com maiores garantias.
